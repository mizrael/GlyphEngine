...
namespace GlyphEngine.Extensions
{
    ...
    /// </summary>
    public static class SpriteBatchPrimitives2DExtensions
    {
        ...
        private static List<Vector2> CreateHexagon(double radius, bool isHexPointyTopped)
        {
            // Look for a cached version of this circle
            String cacheKey = string.Format("hex{0}type{1}", radius, isHexPointyTopped);
            ...
            double addend = (isHexPointyTopped) ? 0.5 : 0;
        ...
        public static void DrawHexagon(this SpriteBatch spriteBatch, Vector2 center, float radius, Color color, bool isHexPointyTopped)
        {
            DrawHexagon(spriteBatch, center, radius, color, isHexPointyTopped, 1f);
        }
        ...
        /// <param name="radius">The radius of the hexagon</param>
        /// <param name="color">The color of the hexagon</param>
        public static void DrawHexagon(this SpriteBatch spriteBatch, Vector2 center, float radius, Color color, bool isHexPointyTopped, float thickness)
        {
            DrawPoints(spriteBatch, center, CreateHexagon(radius, isHexPointyTopped), color, thickness);
        }
